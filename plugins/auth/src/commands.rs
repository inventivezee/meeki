...
#[tauri::command]
#[specta::specta]
pub(crate) fn decode_claims(token: String) -> Result<meeki_supabase_auth::Claims, String> {
    meeki_supabase_auth::Claims::decode_insecure(&token).map_err(|e| e.to_string())
}
...
) -> Result<Option<meeki_template_support::AccountInfo>, String> {
