...
fn to_tantivy_language(lang: &meeki_language::Language) -> Option<Language> {
    match lang.iso639() {
...
pub fn get_tokenizer_name_for_language(lang: &meeki_language::Language) -> &'static str {
...
mod tests {
    ...
    fn test_get_tokenizer_name_for_supported_languages() {
        ...
        for (iso639, expected_tokenizer) in test_cases {
            let lang = meeki_language::Language::from(iso639);
