...
`meeki-tray:allow-set-tray-icon-visible`

</td>
<td>

Enables the set_tray_icon_visible command without any pre-configured scope.
...
`meeki-tray:deny-set-tray-icon-visible`
...
`meeki-tray:allow-set-tray-schedule`
...
`meeki-tray:deny-set-tray-schedule`
