...
`fs-sync:allow-audio-export`

</td>
<td>

Enables the audio_export command without any pre-configured scope.
...
`fs-sync:deny-audio-export`

</td>
<td>

Denies the audio_export command without any pre-configured scope.
...
`fs-sync:allow-audio-source-sha256`

</td>
<td>

Enables the audio_source_sha256 command without any pre-configured scope.
...
`fs-sync:deny-audio-source-sha256`

</td>
<td>

Denies the audio_source_sha256 command without any pre-configured scope.
...
`fs-sync:deny-delete-session-folder`
...
`fs-sync:allow-session-dir`

</td>
<td>

Enables the session_dir command without any pre-configured scope.
...
`fs-sync:deny-session-dir`

</td>
<td>

Denies the session_dir command without any pre-configured scope.
...
Enables the write_json_batch command without any pre-configured scope.
