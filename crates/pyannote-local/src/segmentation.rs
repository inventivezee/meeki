...
impl Segmenter {
    pub fn new(sample_rate: u32) -> Result<Self, crate::Error> {
        let session = meeki_onnx::load_model_from_bytes(SEGMENTATION_ONNX)?;
...
mod tests {
    ...
    test_segmentation!(test_segmentation_english_1, meeki_data::english_1::AUDIO);
    test_segmentation!(test_segmentation_english_2, meeki_data::english_2::AUDIO);
}
