...
use meeki_api_nango::{NangoConnectionState, NangoIntegrationId, Outlook};
use meeki_outlook_calendar::{ListCalendarsResponse, ListEventsResponse, OutlookCalendarClient};
...
pub async fn list_events(
    ...
    let outlook_req = meeki_outlook_calendar::ListEventsRequest {
