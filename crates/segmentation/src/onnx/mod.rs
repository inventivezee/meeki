...
impl Segmenter {
    ...
    pub fn from_model_bytes(model_bytes: &[u8], sample_rate: u32) -> Result<Self> {
        let session = meeki_onnx::load_model_from_bytes(model_bytes)?;
...
mod tests {
    ...
    fn snapshot_english_1() {
        run_snapshot_test(meeki_data::english_1::AUDIO, "segmentation_english_1");
    }

    #[test]
    fn snapshot_english_2() {
        run_snapshot_test(meeki_data::english_2::AUDIO, "segmentation_english_2");
    }

    #[test]
    fn snapshot_korean_1() {
        run_snapshot_test(meeki_data::korean_1::AUDIO, "segmentation_korean_1");
    }

    #[test]
    fn aligns_with_pyannote_community1_on_english_1() {
        let samples = pcm_bytes_to_i16(meeki_data::english_1::AUDIO);
        let sample_rate = 16000u32;
