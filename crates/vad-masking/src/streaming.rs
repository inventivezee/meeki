use meeki_audio_utils::f32_to_i16_samples;
use meeki_vad::earshot::VoiceActivityDetector;
...
impl StreamingVad {
    ...
    pub fn with_config(frame_hint: usize, cfg: VadConfig) -> Self {
        let frame_size = meeki_vad::earshot::choose_optimal_frame_size(frame_hint);
