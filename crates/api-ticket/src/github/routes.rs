...
use meeki_api_nango::{GitHub, NangoConnectionState, NangoIntegrationId};
use meeki_github_issues::{GitHubIssuesClient, IssueStateFilter};
use meeki_ticket_interface::{CollectionPage, CollectionRef, TicketPage};
...
pub async fn list_repos(
    ...
    let repos = client
        .list_repos(meeki_github_issues::ListReposRequest {
...
pub async fn list_tickets(
    ...
    let issues = client
        .list_issues(meeki_github_issues::ListIssuesRequest {
