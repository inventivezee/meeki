...
description: "Use structured Meeki CLI output as an agent-friendly MCP fallback."
---
...
```bash
meeki --json meetings list --query "weekly planning" --limit 10
...
meeki --json meetings history MEETING_ID --limit 10 --offset 0
```
