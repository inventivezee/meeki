# Meeki documentation instructions

## Scope

- This is the Mintlify project published at `https://docs.meeki.ai`.
...
- Use root-relative links between Mintlify pages. Use `https://docs.meeki.ai` in external instructions and agent metadata.
