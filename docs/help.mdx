...
If something is not working, go to [Troubleshooting](/troubleshooting). For a question not covered here, email [hello@meeki.ai](mailto:hello@meeki.ai) or [join Discord](https://meeki.ai/discord).
