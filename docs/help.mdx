...
description: "Find the right guide for the questions people ask most often about Meeki."
---

<CardGroup cols={2}>
  <Card title="Does Meeki join the call?" icon="video-slash" href="/meetings">
    No. Meeki captures microphone and computer audio on your Mac without adding a meeting bot.
  </Card>
...
If something is not working, go to [Troubleshooting](/troubleshooting). For a question not covered here, email [hello@meeki.org](mailto:hello@meeki.org) or [join Discord](https://meeki.org/discord).
