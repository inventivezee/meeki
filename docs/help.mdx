...
If something is not working, go to [Troubleshooting](/troubleshooting). For a question not covered here, email [hello@meeki.so](mailto:hello@meeki.so) or [join Discord](https://meeki.so/discord).
