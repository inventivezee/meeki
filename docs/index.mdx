...
Meeki records your microphone and computer audio without joining the call as a bot. Each meeting stays together as an editable memo, transcript, and summary.

<CardGroup cols={2}>
  <Card title="Try your first meeting" icon="play" href="/quickstart">
    Use the private demo in Meeki, then record a real meeting.
  </Card>
  ...
  <Card title="Choose your AI" icon="sparkles" href="/ai-setup">
    Use Meeki Cloud, your own provider, or local models.
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  <Card title="Can I use Meeki offline?" icon="wifi-slash" href="/offline">
...
3. Take rough notes in **Memos** while Meeki listens.
...
<Note>
  New to Meeki? Open the **Welcome to Meeki** note and click **Join & record**. It uses a private, prerecorded demo meeting.
</Note>
