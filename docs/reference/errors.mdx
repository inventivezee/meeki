...
description: "Interpret CLI failures and recover without modifying Meeki storage."
---
...
| `3` | Database file not found | Open Meeki once or provide the correct database path. |
