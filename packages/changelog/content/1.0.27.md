...
- Chat controls now live inside the chat panel, and the assistant is labeled Meeki AI
- Folder controls have been removed so sessions remain the primary organization model
- App icon and installer artwork updated for the Meeki brand
- In-app web links now point to Meeki pages instead of older Char docs
