...
mod tests {
    ...
    fn generated_guidance_prefers_typed_meeting_interfaces() {
        ...
        assert!(AGENTS_CONTENT.contains("meeki --json meetings list"));
        ...
        assert!(AGENTS_CONTENT.contains("https://docs.meeki.so"));
        assert!(AGENTS_CONTENT.contains("https://docs.meeki.so/skill.md"));
    }
}
