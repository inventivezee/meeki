...
import { MEEKI_SITE_URL, getBlogOgImageUrl } from "@/lib/seo";
...
export const Route = createFileRoute("/blog/$slug")({
  ...
  head: ({ loaderData }) => {
    ...
    if (!article) return {};
    const url = `${MEEKI_SITE_URL}/blog/${article.slug}`;
      ...
      <div className="flex flex-col gap-5 md:flex-row md:items-center md:justify-between">
        <div>
          ...
          <p className="mt-3 max-w-xl text-base leading-7 text-[#4f4940]">
            Try Meeki for private, local-first meeting notes on your Mac.
          </p>
        </div>
        <a
