...
export const Route = createRootRouteWithContext<RouterContext>()({
  head: () => ({
    meta: [
      ...
      { name: "ai-sitemap", content: `${MEEKI_SITE_URL}/llms.txt` },
      { name: "ai-content", content: "public" },
      { name: "apple-mobile-web-app-title", content: "Meeki" },
      ...
      { property: "og:url", content: MEEKI_SITE_URL },
      {
        property: "og:image",
      ...
      { name: "twitter:site", content: "@meeki" },
      { name: "twitter:creator", content: "@meeki" },
      { name: "twitter:title", content: ROOT_TITLE },
      { name: "twitter:description", content: ROOT_DESCRIPTION },
      { name: "twitter:url", content: MEEKI_SITE_URL },
      {
        name: "twitter:image",
        content: DEFAULT_OG_IMAGE_URL,
      },
