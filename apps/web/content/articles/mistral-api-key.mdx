...
To connect Mistral, open Meeki's settings, go to API Keys, paste your key, and that's it. Try it out for free now - [Download Meeki for macOS](https://meeki.so/download/).
