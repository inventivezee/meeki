...
| --- | --- | --- | --- | --- | --- |
| **Anarlog** | Device audio and local transcription | No | Local SQLite with Markdown export | No | Local-first meeting workflows |
...
## 1. Anarlog: best for local-first meeting memory
...
For users who want local-first storage, bot-free capture, and on-device transcription, Anarlog is a strong fit in this comparison. Meetily is another local, open-source option, especially for Windows and Linux users.
