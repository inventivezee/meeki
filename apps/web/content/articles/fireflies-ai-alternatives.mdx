...
Anarlog is an open-source AI notepad for meetings built for high-agency people who demand complete control over their data and AI stack. Meeting data is stored locally in SQLite instead of a vendor-hosted workspace. Markdown is available when you want to export it. It works like Apple Notes with AI superpowers, capturing audio from any meeting platform without joining as a bot.

<Image src="/api/assets/blog/fireflies-ai-alternatives/hyprnote.webp" alt="Anarlog"/>

#### How it compares to Fireflies

Fireflies uses a bot to join meetings. Anarlog captures system audio directly and keeps meeting data in local SQLite by default. You can choose an AI stack and export Markdown when you need a portable record.
...
[**Download Anarlog for macOS**](/download) if that is the kind of system you would rather build on.
