...
| Meeki                       | Privacy-focused Mac users    | Desktop software (macOS)       | Zero cloud dependency       | macOS only                  | Free                        |
...
[Meeki](/) is an open-source AI notepad for meetings that gives you complete control over your data, AI stack, and workflow. Meeting data is stored locally in SQLite on your device. Optional sync, sharing, and hosted AI use explicit data paths.

You can inspect the code, customize functionality, and choose which AI processes your data. Zero lock-in, zero compromises.

![Meeki](/api/assets/blog/plaud-ai-alternatives/hyprnote.webp)

#### How it works

Meeki sits quietly on your computer and captures audio directly from your system without bots joining your calls. While you're in a meeting, it generates a live transcript as you take your own notes alongside it.
...
Meeting data is stored locally in SQLite. You can export Markdown when you need a portable copy. If you enable cloud AI, CloudSync, or sharing, evaluate those services separately for the meeting's data-handling requirements.
...
- **Local SQLite storage:** Canonical meeting data stays on your device; export Markdown when it fits your workflow
...
- Open-source code, local-first storage, Markdown export, and AI-provider choice
...
Meeki is free forever for local transcription, BYOK, and all core features. No artificial caps, no trial that expires.
...
**Choose Meeki** if you're on a Mac and want a local-first, bot-free meeting workflow with AI-provider choice. For sensitive work, configure local processing where appropriate and complete your own security and compliance review before adopting any tool.
...
Ready to take meeting notes without the cloud dependency or subscription treadmill? Meeki gives you unlimited transcription and AI summaries completely free—no credit card, no trials that expire, no catch.

**[Download Meeki for macOS](/download)** and start recording your first meeting in under 2 minutes. Your data stays yours, on your device, forever.
