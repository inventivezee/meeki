...
[Anarlog](/) is an open-source AI notepad for meetings that gives you complete control over your data, AI stack, and workflow. Meeting data is stored locally in SQLite on your device. Optional sync, sharing, and hosted AI use explicit data paths.

You can inspect the code, customize functionality, and choose which AI processes your data. Zero lock-in, zero compromises.

![Anarlog](/api/assets/blog/plaud-ai-alternatives/hyprnote.webp)
...
### Try Anarlog for free

Ready to take meeting notes without the cloud dependency or subscription treadmill? Anarlog gives you unlimited transcription and AI summaries completely free—no credit card, no trials that expire, no catch.

**[Download Anarlog for macOS](/download)** and start recording your first meeting in under 2 minutes. Your data stays yours, on your device, forever.
