...
Because Anarlog is local-first and supports Markdown export, it can sit alongside an existing vault without making files its canonical database. It treats meetings as a specialized region of your brain—deeply integrated, but not controlling everything else.
