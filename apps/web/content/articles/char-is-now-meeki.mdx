---
meta_title: "Char Is Now Meeki"
display_title: "Char Is Now Meeki"
meta_description: "The AI meeting notetaker you've been using is now Meeki — open source, MIT, free forever, fully local. Char is a different product now: an AI notepad that finishes your todos. Two names because they're two different products."
author: "John Jeong"
featured: true
...
The AI meeting notetaker you've been using is now **[Meeki](https://github.com/inventivezee/Meety)**. Same app, same files, same 8.3k⭐ on GitHub. New name, new license (MIT), and a clear single purpose: an open-source meeting notetaker that runs on your machine.
...
If you're here for meeting notes — you're in the right place. meeki.org is the new home. char.com/blog/\* redirects here.
...
- Open source on GitHub: [github.com/inventivezee/Meety](https://github.com/inventivezee/Meety)
...
If you're already running Char (the desktop app), it'll keep working. The next update will rename itself to Meeki. Your local meeting data stays on your device, and your stack does not change. We're keeping the pro AI models and the calendar integration in Meeki through the migration window — nothing gets ripped out from under you.

After the migration, Meeki stays as a community-maintained OSS project. We'll keep it running. Patches, security fixes, the occasional feature. But the team's daily focus moves to the new Char.
...
If that sounds interesting, [char.com](https://char.com) is the place. If it doesn't — totally fine. Stay on Meeki, take your meeting notes, own your files. We built it for you.
