...
The AI meeting notetaker you've been using is now **[Meeki](https://github.com/fastrepl/meeki)**. Same app, same files, same 8.3k⭐ on GitHub. New name, new license (MIT), and a clear single purpose: an open-source meeting notetaker that runs on your machine.
...
- Open source on GitHub: [github.com/fastrepl/meeki](https://github.com/fastrepl/meeki)
