...
If you value both functionality and local-first control, Anarlog is worth a look. Meeting data stays in local SQLite by default, and you can export Markdown when a portable copy fits the workflow.
