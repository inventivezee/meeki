...
meta_description: "A no-fluff guide to the tools that fix different parts of a broken meeting workflow - and where Anarlog fits in."
author:
  - "John Jeong"
featured: false
...
- **Anarlog**: for capturing what happens in meetings without giving up control of your data
...
### 1. Anarlog: best AI notepad for meetings
...
<u>[Anarlog](https://anarlog.so)</u> (formerly Hyprnote) is an open-source AI notepad for meetings, built for people who want complete control over their files, their AI stack, and what happens to their data. 
...
- **Your choice of AI stack** - use Anarlog's managed cloud, bring your own API keys (OpenAI, Anthropic, Deepgram), or run fully local via Ollama or LM Studio
...
**Capturing what was said and decided**: Anarlog (zero lock-in, no bot, your AI stack) or Grain (team-first, video clips, CRM sync)
