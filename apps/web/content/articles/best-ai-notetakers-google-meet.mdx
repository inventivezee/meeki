...
Most transcription software forces you into their cloud, their servers, their rules. **[Meeki](https://meeki.ai)** is an open-source AI note-taker that stores your data locally and gives you complete control over the AI stack.
...
- Privacy concerns with an ongoing **[class-action lawsuit](https://meeki.ai/blog/is-otter-ai-safe)** regarding data handling practices
