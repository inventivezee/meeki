...
- **Choose Anarlog** when you want bot-free capture, local transcription, and a local-first meeting record on your own computer.
...
| Anarlog | Desktop audio capture and local transcription | No | Local SQLite with Markdown export | Local-first, bot-free meeting notes |
...
Use Anarlog if you want bot-free capture, local transcription, a local meeting record, and control over the AI model used for summaries.
...
[Download Anarlog for macOS](/download) if you want Microsoft Teams notes without a meeting bot, with local transcription and meeting data stored on your computer.
