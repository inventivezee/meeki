...
**Install:** brew install anarlog, or clone the [MIT-licensed repo](https://github.com/fastrepl/anarlog) and build from source.

**Transcription:** Pick from 9 STT providers in Preferences. Local Parakeet models run fully on-device, and the other providers are cloud BYOK: paste your API key, audio goes to that provider, Anarlog never touches it.
...
- If you want a full meeting workspace, Anarlog is the most complete option on this list. 
