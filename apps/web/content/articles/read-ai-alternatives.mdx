...
Meeki is free for unlimited local transcription. [Download it for free](https://meeki.so/download/apple-silicon) and try it on your next call. No account required, no calendar permissions, no data leaves your machine unless you want it to.
