...
[Meeki](https://meeki.so) is an open-source AI notepad for meetings, built for people who want to own their data. 
...
If you want prefer the local-first approach, [download Meeki](https://meeki.so/download/apple-silicon) and try it on your next meeting.
