...
- Save your notes in your desired folder. If Anarlog disappeared tomorrow, your data would still be exactly where you left it.
- You choose your own AI stack: Anarlog's managed cloud, your own API keys (OpenAI, Anthropic, Deepgram), or fully local models through Ollama or LM Studio for offline operation.
...
- Works on macOS and Windows, which gives it broader reach than Anarlog's macOS/Linux support.
...
**Anarlog** is the pick if data ownership is non-negotiable: local SQLite storage, portable exports, your choice of AI, and a local-only configuration.
