...
| ------------------------ | ------------------------------------------------------ | -------------------------------------- |
| Meeki                     | AI meeting notes with local storage and your own LLM   | Free (BYOK) / Pro $15/mo or $150/year |
...
- No mobile app. If you need to record a call from your phone, Meeki can't help yet.
- No built-in CRM integrations. Meeting notes stay in Meeki unless you export or sync manually.
...
The Free plan supports on-device transcription and your own API keys. Pro is $15/month or $150/year and adds hosted transcription, cloud AI, encrypted CloudSync, and calendar integrations. For a developer running Ollama locally, the free tier supports a local workflow without a managed AI subscription.
...
It's early. Check the product directly for its current platform, AI-provider, and sync support. The zero-config MCP integration is the kind of thing that feels obvious once you see it. If you use Claude as a daily tool and want your notes to be part of that conversation without any glue code, Novi Notes is worth watching.
...
If your main problem is meeting notes and you want to own the transcript, Meeki captures system audio without a bot, stores everything locally, and lets you run any LLM you want. The tradeoff is macOS-only for now.
...
For meeting notes specifically, you can [download Meeki](https://meeki.org/download) and try it in your next meeting.
