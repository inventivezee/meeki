...
| ------------------------ | ------------------------------------------------------ | -------------------------------------- |
| Anarlog                     | AI meeting notes with local storage and your own LLM   | Free (BYOK) / Pro $15/mo or $150/year |
...
- Install with brew install --cask fastrepl/fastrepl/anarlog. There's a CLI. The repo is public on GitHub.
...
- No built-in CRM integrations. Meeting notes stay in Anarlog unless you export or sync manually.
...
If your main problem is meeting notes and you want to own the transcript, Anarlog captures system audio without a bot, stores everything locally, and lets you run any LLM you want. The tradeoff is macOS-only for now.
...
For meeting notes specifically, you can [download Anarlog](https://anarlog.so/download) and try it in your next meeting.
