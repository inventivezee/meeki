...
## A practical decision-log workflow in Meeki

Meeki is designed around the idea that you should remain the note-taker while AI handles the mechanical work around you.
...
3. Let Meeki transcribe the conversation while you stay engaged.
...
If you need a better capture layer for that workflow, [Meeki](https://meeki.org) provides bot-free meeting transcription, editable summaries, templates, chat, and on-device or bring-your-own-key AI.
...
Ready to build a meeting record you can verify and keep? [Download Meeki](/download).
