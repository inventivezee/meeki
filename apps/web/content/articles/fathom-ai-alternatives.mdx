...
### 1. Anarlog: For When Control Actually Matters
...
Anarlog is an open-source AI notepad for meetings. Meeting data is stored locally in SQLite on your device. Markdown is available when you want to export it. You choose which AI processes your data: managed cloud, bring your own API keys, or run local models.
...
<Image src="/api/assets/blog/fathom-ai-alternatives/fathom-1.webp" alt="Anarlog vs Fathom" />
