...
| --------- | -------------------------------------------------- | ------------------------------- |
| Meeki  | Zero lock-in, complete control                     | Free forever (local + BYOK). Cloud: $25/mo |
...
### 1. Meeki: For When Control Actually Matters

Full disclosure—I'm the co-founder of [Meeki](/). I built it because every other tool locked you into their cloud, their models, their rules. No way to switch, no way out.

Meeki is an open-source AI notepad for meetings. Meeting data is stored locally in SQLite on your device. Markdown is available when you want to export it. You choose which AI processes your data: managed cloud, bring your own API keys, or run local models.

You get a real notepad interface. Open Meeki and you see a notepad. Type notes during meetings, and the AI enhances them with context from the transcript. Real-time transcription appears while people are talking, not after.
...
<Image src="/api/assets/blog/fathom-ai-alternatives/fathom-1.webp" alt="Meeki vs Fathom" />
...
The Free plan supports on-device transcription and your own API keys. Pro is $15/month or $150/year and adds hosted transcription, cloud AI, encrypted CloudSync, and calendar integrations. Check the current pricing page before making a purchasing decision.
...
- Cloud-only processing; compare its deployment model with your own requirements
...
**If control and zero lock-in matter, use Meeki.** Local SQLite storage, portable exports, your choice of AI stack, and complete ownership. Engineers, developers, privacy-conscious professionals in healthcare and legal, or anyone whose company has banned cloud tools—Meeki gives you ownership at the foundational level. You also get real-time transcription and offline support that Fathom can't match.
