...
For a detailed analysis of these security concerns and documented incidents, see <u>[Is Otter AI Safe: What You Need to Know](https://meeki.so/blog/is-otter-ai-safe/)</u>.
...
| [Meeki](https://meeki.so) | Local-first meeting data and AI-provider choice | Free (BYOK) / Pro $15/month or $150/year | Open source. Local SQLite with Markdown export. |
...
See <u>[detailed reviews of all Otter AI competitors](https://meeki.so/blog/otter-ai-alternatives/)</u>.
