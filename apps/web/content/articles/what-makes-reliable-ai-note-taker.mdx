...
## How we're building Anarlog

We're designing Anarlog around dependency thinking.
...
**Your choice of AI stack.** Anarlog works fully offline out of the box, but you're not locked into local-only. Use the managed cloud service for the easiest setup, bring your own API keys (OpenAI, Anthropic, Mistral, and others), or run local models via Ollama or LM Studio. Switch anytime. No lock-in.

**Deployment clarity.** Anarlog is open source and stores meeting data locally by default. That makes the desktop data path inspectable; it does not imply a supported self-hosted or private-cloud deployment.

**Direct audio capture.** Anarlog captures system audio and microphone input directly at the OS level. No bots. No platform permissions. No dependency on Zoom or Teams policies. Works for all meeting platforms and in-person conversations.
...
[Download Anarlog for macOS](/download).
