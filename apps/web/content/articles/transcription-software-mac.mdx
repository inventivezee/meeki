...
### 1. Anarlog: best for privacy and unlimited local transcription

[Anarlog](/) is an open-source AI notepad for meetings built for Mac. Meeting data is stored locally in SQLite, with Markdown export when you need it. You choose your AI stack: managed cloud, BYOK, or local models.
...
### Local processing (Anarlog, MacWhisper)
