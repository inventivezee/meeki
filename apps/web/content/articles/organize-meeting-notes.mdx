...
Anarlog, on the other hand, keeps meeting notes in local SQLite on your own device. That local-first design matters when you want the meeting record close to your work.
...
The local SQLite record remains canonical in Anarlog. Export is a deliberate handoff, not a second live database to maintain.
