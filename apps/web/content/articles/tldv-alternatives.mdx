...
| ------------ | --------------------------------------------- | ----------------------------------------- | --------- |
| Meeki         | Data ownership, privacy, offline use          | Free (local + BYOK). Cloud: $25/mo        | Yes       |
...
[Meeki](/) is an open-source AI notepad for meetings that keeps meeting data in local SQLite on your device. You can export Markdown when you need a portable copy, and cloud features remain optional.
...
Meeki skips the video entirely and gives you text-based meeting intelligence with complete data ownership.

tl;dv Pro is $29/month. Meeki is free for local transcription and BYOK, or $25/month for managed cloud. If you left tl;dv over pricing or privacy, the gap here is still meaningful.
...
- Portable exports and provider choice. You can switch AI providers and export your meeting data when needed
...
<CtaCard title="Try Meeki for free" description="Open-source meeting notes. Your data stays on your device." buttonText="Download Meeki" buttonUrl="/download" />
...
Meeki is worth trying if you value both functionality and control.
