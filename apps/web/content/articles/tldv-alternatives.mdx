...
[Anarlog](/) is an open-source AI notepad for meetings that keeps meeting data in local SQLite on your device. You can export Markdown when you need a portable copy, and cloud features remain optional.
