...
| **Anarlog**       | Users who want a local-first meeting workflow and AI-provider choice | Free (BYOK), Pro $15/mo or $150/year |
...
The AI stack is yours to choose: Anarlog's managed cloud service, your own API keys, or fully local models through Ollama or LM Studio for offline operation. The canonical meeting record stays in local SQLite; attachments and recordings remain local files, and you decide whether to enable cloud services.
