...
**[Meeki](https://meeki.ai/)** is an open-source AI notepad built specifically for meetings. It transcribes your conversations in real time and combines the transcript with your manual notes to create a structured summary. No bots join your calls; meeting data is stored locally in SQLite, and you can choose your preferred STT and LLM provider.
