...
Anarlog works differently. You decide how your data is processed — [local models on your device](/blog/local-ai-meeting-notes/), your own cloud API keys, or Anarlog's managed service. Meeting data stays in local SQLite by default, and IT teams can audit the open-source code. That gives you more control over the compliance questions you still need to assess.
...
[Download Anarlog for MacOS](/download) to take control of your meeting data.
