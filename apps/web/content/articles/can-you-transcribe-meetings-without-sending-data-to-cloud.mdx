...
meta_description: "Learn how to transcribe meetings without sending data to the cloud. Discover local AI tools like Meeki that keep conversations on-device and completely private."
author:
  - "John Jeong"
featured: false
category: "Guides"
...
**Short answer: Absolutely. And with Meeki, you choose exactly how.**
...
## **Enter Meeki: the AI notepad built around your choice**

[Meeki](https://meeki.org) is an open-source AI notepad for meetings with zero lock-in and complete control over your data and AI stack.

### **You control how your data is processed**

Meeki lets you configure your own stack:

- **Transcription** — run it locally on your device, or use cloud APIs like Deepgram or AssemblyAI
- **AI Summarization** — use your own API keys (OpenAI, Anthropic, and others), run local models via Ollama or LM Studio, or use Meeki's managed service
- **Storage** — canonical meeting data stays locally in SQLite; Markdown is available as an export

### **Universal platform compatibility**

Meeki captures your microphone input and system audio directly — no bots joining your calls, no calendar permissions required. It works with all meeting platforms (Zoom, Teams, Meet, Slack), in-person meetings, and phone calls routed through your computer, with no platform-specific integrations needed.

### **Your files, your format**

Meeting data stays in local SQLite on your device. Export Markdown when you need a portable copy or want to move notes into another workflow.

## **Does more control mean worse performance?**

No. Meeki delivers real-time transcription, AI summaries with action items and key decisions, custom templates for different meeting types, AI chat to query your transcripts, search across your meeting history, and support for 45+ languages including English, Spanish, French, German, Japanese, Portuguese, Italian, Dutch, Korean, and Chinese.

## **Meeki's privacy vs. performance spectrum**
...
Want help configuring your setup? [Get in touch with our team](https://meeki.org).
...
Meeki lets you decide — local, hybrid, or cloud with your own API keys — with full visibility into what's happening, backed by open-source code you can inspect.
...
Meeki can produce transcripts and summaries without retaining the original audio. You decide what gets stored and where.

### **3. Can you use local transcription for languages other than English?**

Yes. Meeki supports 45+ languages including English, Spanish, French, German, Japanese, Portuguese, Italian, Dutch, Korean, and Chinese. If you want stronger multilingual AI summarization, you can connect your own cloud LLM provider.
