...
[Meeki](https://meeki.so) is an open-source AI notepad for meetings with zero lock-in and complete control over your data and AI stack.
...
Want help configuring your setup? [Get in touch with our team](https://meeki.so).
