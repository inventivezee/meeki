...
- **Meeki** → Zero lock-in, complete control over data and AI stack
...
[Meeki](/) is an open-source AI notepad for meetings built for high-agency people who demand complete control. Meeting data is stored locally in SQLite on your device. Markdown is available when you want to export it. You choose your AI stack: managed cloud, bring your own keys, or run local models.
...
Meeki is free forever for local transcription, BYOK, and all core features. Managed cloud service is $25/month for the easiest setup.
...
Unlike tools like Meeki that work offline and provide real-time transcription, Zoom AI Companion requires cloud processing and doesn't offer live transcription during meetings.
...
If you want notes you can keep, move, audit, and run outside Zoom's ecosystem, the list gets much shorter. That is why Meeki is the one I would start with. The notes stay as files, the AI layer stays flexible, and the workflow does not collapse if you change providers later.

[Download Meeki for macOS](/download) if that is the setup you want to own.
