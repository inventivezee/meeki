...
The AI meeting notetaker you've been using is now **[Anarlog](https://github.com/fastrepl/anarlog)**. Same app, same files, same 8.3k⭐ on GitHub. New name, new license (MIT), and a clear single purpose: an open-source meeting notetaker that runs on your machine.
