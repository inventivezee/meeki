...
<Image src="/api/assets/blog/how-to-transcribe-zoom-calls/auto-3.webp" alt="download Anarlog app for Zoom" />
...
3. Open the DMG file and drag Anarlog to your Applications folder
4. Launch Anarlog from Applications

#### Step 2: Start recording your meeting

<Image src="/api/assets/blog/how-to-transcribe-zoom-calls/auto-4.webp" alt="How does Anarlog work for Zoom" />
...
<Image src="/api/assets/blog/how-to-transcribe-zoom-calls/auto-5.webp" alt="Anarlog for zoom calls" />

1. After your meeting ends, press the stop button
2. Anarlog automatically processes the transcript using its custom HyperLLM-V1 model
...
Zoom processes conversations in the cloud, raising compliance concerns for sensitive industries. Anarlog keeps everything on your device with no data leaving your computer.
