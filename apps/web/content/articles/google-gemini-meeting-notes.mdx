...
If I have to recommend one platform that works universally, is free, and keeps your data local, it's Meeki.

Quick note: I'm the co-founder of Meeki, but my recommendation isn't just personal bias—the platform delivers results.
...
- Review the consent requirements that apply to your meetings before recording
- Stores the meeting record locally in SQLite, with Markdown export when you need a portable copy

Meeki's note-taking features specifically:

![Meeki](/api/assets/blog/google-gemini-meeting-notes/gemini-2.webp)
...
Want to try Meeki? [Download it for free](/download)!
...
You have two main options: Google Meet's built-in transcription (which requires expensive Workspace subscriptions) or a third-party tool like Meeki.

Unlike cloud-based tools like Otter or Fireflies that send your conversations to their servers, Meeki provides unlimited real-time transcription completely free while keeping everything local on your device.
...
Yes—Meeki is a completely [free AI note taker](/blog/free-ai-notetakers) that works with Google Meet, Zoom, Teams, and any other meeting platform.

Unlike Google's "Take notes with Gemini" feature, which requires expensive Workspace subscriptions, Meeki's core transcription and note-taking features are free forever.
