...
Anarlog's note-taking features specifically:

![Anarlog](/api/assets/blog/google-gemini-meeting-notes/gemini-2.webp)
...
Want to try Anarlog? [Download it for free](/download)!
...
You have two main options: Google Meet's built-in transcription (which requires expensive Workspace subscriptions) or a third-party tool like Anarlog.

Unlike cloud-based tools like Otter or Fireflies that send your conversations to their servers, Anarlog provides unlimited real-time transcription completely free while keeping everything local on your device.
...
Yes—Anarlog is a completely [free AI note taker](/blog/free-ai-notetakers) that works with Google Meet, Zoom, Teams, and any other meeting platform.

Unlike Google's "Take notes with Gemini" feature, which requires expensive Workspace subscriptions, Anarlog's core transcription and note-taking features are free forever.
