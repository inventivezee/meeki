...
[Anarlog](https://anarlog.so) is built for people who want AI meeting notes without handing every meeting to a cloud bot.

It captures system audio from your desktop, transcribes meetings in real time, and keeps the meeting record in local SQLite. You can export Markdown when you need a portable copy, then choose Anarlog's managed service, bring your own API keys, or run local models through tools like Ollama or LM Studio.
